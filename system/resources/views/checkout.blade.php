...
<body>
  ...
  <!-- ======= Top Bar ======= -->
  <section id="topbar" class="d-none d-lg-flex align-items-center fixed-top topbar-dark">
    ...
    <section id="book-a-table" class="book-a-table">
      <div class="container">
        ...
        <div class="section-title">
          ...
          <p>jika anda ingin memesan silahkan isi form dibawah ini.</p>
        </div>
        ...
        <form action="forms/book-a-table.php" method="post" role="form" class="php-email-form">
          <div class="form-row">
            ...
            <div class="col-lg-4 col-md-6 form-group">
              <input type="text" class="form-control" name="phone" id="phone" placeholder="Nomor Hp" data-rule="minlen:4" data-msg="Please enter at least 4 chars">
              <div class="validate"></div>
            </div>
            <div class="col-lg-4 col-md-6 form-group">
            ...
            <div class="col-lg-4 col-md-6 form-group">
              <input type="number" class="form-control" name="people" id="people" placeholder="Jumlah" data-rule="minlen:1" data-msg="Please enter at least 1 chars">
              <div class="validate"></div>
            </div>
          </div>
          <div class="form-group">
            <textarea class="form-control" name="message" rows="5" placeholder="Pemesanan"></textarea>
            <div class="validate"></div>
          </div>
          <div class="mb-3">
          ...
          <div class="text-center"><button type="submit">mengirim pesanan</button></div>
        </form>
    ...
    <section id="about" class="about">
      <div class="container-fluid">
        ...
        <div class="row">
          ...
          <div class="col-lg-7 d-flex flex-column justify align-items-stretch">
...
<br>
  ...
  <footer id="footer">
    <div class="container">
      <h3>fifteen celsius</h3>
      <p>Restoran dan tempat santai yang cocok untuk bersantai dan liburan bersama keluarga.</p>
      ...
      <div class="copyright">
        &copy; Copyright <strong><span>fifteen celsius</span></strong>. All Rights Reserved
      </div>
      <div class="credits">
