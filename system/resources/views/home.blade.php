      ...
      <div id="heroCarousel" class="carousel slide carousel-fade" data-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
          ...
          <div class="carousel-item active" style="background: url(assets/img/slide/slide-1.jpg);">
            <div class="carousel-background"><img src="{{ url ('public')}}/assets/img/slide/slide-1.jpg" alt=""></div>
            <div class="carousel-container">
              <div class="carousel-content">
                <h2 class="animate__animated animate__fadeInDown"><span>Fifteen Celcius</span> Skylounge</h2>
                <p class="animate__animated animate__fadeInUp">Di Malang Raya, salah satunya adalah Fifteen Celcius Skylounge. Tempat ini disebut-sebut sebagai tempat "nongkrong" beratapkan langit dengan view terindah di Malang Raya.Tempat ini menyajikan sebuah</p>
          ...
          <div class="carousel-item" style="background: url(assets/img/slide/slide-2.jpg);">
            <div class="carousel-background"><img src="{{ url ('public')}}/assets/img/slide/slide-2.jpg" alt=""></div>
            <div class="carousel-container">
              <div class="carousel-content">
